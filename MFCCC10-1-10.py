...
def optimize_mfo_ccc(pop_size, lower_bound, upper_bound, iterations=10, rmp=0.5):
    # Initialize population
    population = initialize_population(pop_size, lower_bound, upper_bound)

    for iteration in range(iterations):
        # Evaluate fitness for both tasks
        ranked1, fitness1 = factorial_rank(population, f1)
        ranked2, fitness2 = factorial_rank(population, f2)
        ...
        print(f"Factorial Rank (for Task 1): {ranked1}")
        print(f"Factorial Rank (for Task 2): {ranked2}")
        print(f"Skill Factor: {skill_factors}")  # 0 for task 1 and 1 for task 2
